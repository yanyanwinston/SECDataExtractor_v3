...
class TestViewerJSONStructure:
    ...
    def test_handle_malformed_json_structure(self):
        ...
        for malformed_json in malformed_cases:
            try:
                ...
                if (
                    "sourceReports" in malformed_json
                    and malformed_json["sourceReports"]
                    and "targetReports" in malformed_json["sourceReports"][0]
                    and malformed_json["sourceReports"][0]["targetReports"]
                ):
    ...
    def test_validate_required_components(self):
        ...
        for component in required_components:
            ...
            assert isinstance(
                target_data[component], dict
            ), f"Component {component} should be dict"
