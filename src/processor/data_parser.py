...
class DataParser:
    ...
    def __init__(
        ...
        self.latest_statement_tables: List[StatementTable] = []
    ...
    def _parse_with_presentation(
        ...
        self.latest_statement_tables = statement_tables
    ...
    def get_latest_statement_tables(self) -> List[StatementTable]:
        """Return the most recent StatementTable objects generated by parse."""

        return list(self.latest_statement_tables)
