...
class ViewerJSONAnalyzer:
    ...
    def analyze_presentation_tree(self, role_id: str) -> Dict[str, Any]:
        ...
        tree_info = {
            ...
            'total_child_relationships': sum(len(children) for children in pres_data.values()),
    ...
    def _calculate_max_depth(self, pres_data: Dict[str, Any], root_concepts: List[str]) -> int:
        ...
        return max(get_depth(root, set()) for root in root_concepts) if root_concepts else 0

    def _build_tree_structure(self, concept: str, pres_data: Dict[str, Any],
        ...
        for child_rel in pres_data.get(concept, [])[:5]:  # Limit to first 5 children
            ...
            child_tree = self._build_tree_structure(child_concept, pres_data, depth + 1, max_depth)
